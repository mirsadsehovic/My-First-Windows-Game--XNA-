...
namespace WindowsGame2
{
    ...
    class MovingTiles
    {
       ...
       // private Vector2 gravityAcceleration = new Vector2(0.0f, 12.0f);
        ...
        private State m_currentState = State.Left;
       
        internal void SetState()
        {
            m_currentState = State.Left;
        }

        internal void Update(float a_elpasedTime)
        {
           Vector2 gravityAcceleration = new Vector2(10.0f, 0f);
            //integrate position
